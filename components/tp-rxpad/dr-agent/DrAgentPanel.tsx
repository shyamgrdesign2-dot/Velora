    ...
    <div id="dr-agent-panel-root" className="relative flex h-full w-full flex-col overflow-hidden bg-white">
      ...
      */}
      ...
      <div className="sticky bottom-0 z-10 shrink-0 bg-white">
        ...
        {/* Homepage mode hides the suggestion-pills row entirely —
            the bottom strip is now just the trust marker + patient
            chip (rendered inside ChatInput). Other surfaces keep
            the legacy pills row. */}
        {mode !== "homepage" && effectivePills.length > 0 && messages.length > 0 && !isTyping && (!glanceInlinePillsActive || !!veloraV0PivotPills) && (
