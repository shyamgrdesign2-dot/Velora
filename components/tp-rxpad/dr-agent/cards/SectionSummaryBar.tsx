 ...
 * Default fill: TP Slate 100 at 70% opacity (subtle on white card bodies).
 * Use above block content; do not use as an inline chip (see SectionTag for tag+value rows).
 */
