...
### SectionTag
Section heading with icon. Default background **`tp-slate-100` at 70% opacity** (`bg-tp-slate-100/70` — `#F1F1F5` translucent on the card so the section strip stays subtle); hover uses solid **`tp-slate-100`**.
