...
export const SMART_SUMMARY_BY_CONTEXT: Record<string, SmartSummaryData> = {
  // ═══════════════ Velora v0 — five canonical patients (one per intent) ═══════════════
  // Minimal summaries — full per-intent content lives in lib/velora/v0-replies.ts.
  // The panel only needs these keys to exist so detectSpecialties + buildIntroMessages
  // don't crash. Reply pipeline is overridden by replyOverride.
