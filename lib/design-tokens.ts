    ...
    groups: [
      {
        ...
        tokens: [
          ...
          { token: "TP.bg.section.header", usage: "SectionSummaryBar + SectionTag default fill — tp-slate-100 (#F1F1F5) at 70% opacity so the bar blends on white card bodies", source: "tp-slate-100/70", value: "rgba(241,241,245,0.7) over white" },
